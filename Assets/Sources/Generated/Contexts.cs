...
public partial class Contexts : Entitas.IContexts {
    ...
    public SettignsContext settigns { get; set; }

    public Entitas.IContext[] allContexts { get { return new Entitas.IContext [] { audio, framework, game, gameState, gUI, input, network, settigns }; } }
...
public partial class Contexts {
    ...
    public void InitializeContextObservers() {
        try {
            ...
            CreateContextObserver(settigns);
